    ...
    <div class="card">
        <div class="card-header bg-light">
            ...
            <p class="text-sm mb-0">
                Buat kelas pertandingan baru dan tentukan rentang usianya.
            </p>
        </div>
        <div class="card-body">
            <form action="{{ route('superadmin.kelas.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('nama_kelas') is-invalid @enderror" id="nama_kelas" name="nama_kelas" value="{{ old('nama_kelas') }}" placeholder="Contoh: Kelas A Putra (26 - 28 kg)" required>
